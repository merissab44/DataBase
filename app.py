...
app = Flask(__name__)
# this stores the location of our online database
...
# Perform C.R.U.D operations = CREATE, READ, UPDATE, DELETE
...
def plants_list():
    ...
    plants_list = mongo.db.plants.find({})
...
def create():
    ...
    if request.method == 'POST':
        ...
        # CREATE
        create_plant = mongo.db.plants.insert_one(new_plant)
        # READ
        return redirect(url_for('detail', plant_id=create_plant.inserted_id))
